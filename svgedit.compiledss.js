        ...
        window.svgEditor = function(a) {
            ...
            var c, i, s = svgedit.utilities,
                ...
                A = ["ext-overview_window.js",
                    "ext-markers.js", "ext-connector.js", "ext-eyedropper.js", "ext-shapes.js", "ext-imagelib.js","ext-artlib.js", "ext-grid.js", "ext-polygon.js", "ext-star.js", "ext-panning.js", "ext-storage.js", "ext-fliptools"
                ],
                p = {
                    canvasName: "default",
                    canvas_expansion: 3,
            ...
            o.init = function() {
                ...
                var Za = '<div id="none" class="palette_item" data-rgb="none"></div>';
                ...
                a("#palette").append(Za);
                Za = "";
                a.each(["#FFF", "#888", "#000", "#a3bdc8", "#93898e", "#bc727a", "#f2d1cc", "#FF0000", "#FFFFFF", "#00FFFF", "#C0C0C0", "#0000FF", "#808080", "#0000A0", "#000000", "#ADD8E6", "#FFA500", "#800080", "#A52A2A", "#FFFF00", "#800000", "#00FF00", "#008000", "#FF00FF", "#808000"], function() {
                        ...
                        a.select("Select an image type for export: ", ["PNG", "JPEG", "BMP", "WEBP"], function(h) {
                            if (h) {
                                if (!q.exportImage && !q.pngsave) {
                                    var k = v.notification.loadingImage1;
